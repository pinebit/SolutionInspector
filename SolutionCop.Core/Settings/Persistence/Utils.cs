namespace SolutionCop.Core.Settings.Persistence
{
    ...
    internal static class Utils
    {
        ...
        public static bool? ReadOptionalFlag(string settingsFile, XElement root, string name)
        {
            ...
            {
                throw new SolutionCopSettingsException(settingsFile, "Boolean setting " + name + " has wrong value " + flag.Value);
            }
        }
        ...
        public static XElement GetSingleOptionalElement(string settingsFile, XElement root, string name)
        {
            ...
            throw new SolutionCopSettingsException(settingsFile, "Element " + name + " must appear once");
        }
    }
}
